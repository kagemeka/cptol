...
import py.cptol.atcoder.submitted
...
class UserSessionAgent:
    ...
    def fetch_my_submissions(
        self,
        contest_id: str,
        params: atcoder.submitted.SubmissionsSearchParams | None = None,
    ) -> typing.Iterator[atcoder.submitted.SubmissionResult]:
        self.__update_session()
        assert self.__session is not None
        yield from atcoder.submitted.fetch_all_my_submissions(
            self.__session,
            contest_id,
            params,
        )
